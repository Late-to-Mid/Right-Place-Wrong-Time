...
namespace PlayerScripts
{
    ...
    public class PlayerWeaponsManager : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            weapon.SetAnimAimParameter(isAiming, m_PlayerCharacterController.isSprinting, m_PlayerCharacterController.isSliding, !m_PlayerCharacterController.isGrounded, m_PlayerCharacterController.isCrouching);
